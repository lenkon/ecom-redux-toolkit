...
const Slider = () => {
  ...
  return (
    <div className='relative pb-4'>
      ...
      <div>
        <button 
          className="bg-white hover:bg-color-green absolute top-1/2 right-4 -translate-y-1/2 rounded-full p-2"
        ...
        <button 
          className="bg-white hover:bg-color-green absolute top-1/2 left-4 -translate-y-1/2 rounded-full p-2"
